...
var BillingView = function BillingView(_a) {
  ...
  var savedPaymentMethods = useMemo(function () {
    return distinctBy(rawSavedPaymentMethods, "addressId");
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(CheckoutItemCostBreakdown, {
    ...
    progress: 50
  }), showSaved ? /*#__PURE__*/React__default.createElement(SavedBillingDetailsSelector, {
    ...
    onNext: onNext,
    onClose: onClose
  }) : /*#__PURE__*/React__default.createElement(BillingInfoForm // variant="loggedIn"
  , {
    // variant="loggedIn"

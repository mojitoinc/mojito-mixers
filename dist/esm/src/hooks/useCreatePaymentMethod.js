    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ciphertext = _b.sent();
                    return [2 /*return*/, btoa(ciphertext)];
            }
        });
    });
}
function useCreatePaymentMethod() {
    ...
    var _a = useCreatePaymentMethodMutation(), createPaymentMethod = _a[0], createPaymentMethodResult = _a[1];
    var extendedCreatePaymentMethod = useCallback(function (orgID, billingInfo, paymentInfo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (!(paymentInfo.type === PaymentType.CreditCard)) return [3 /*break*/, 3];

...
function useFullPayment(_a) {
  ...
  var createBuyNowInvoice = useCreateBuyNowInvoiceMutation()[0]; // TODO: There's another mutation, PurchaseBuyNow, to create invoice and pay that also makes a reservation.
      ...
      return __generator(this, function (_k) {
        switch (_k.label) {
          ...
          case 7:
            ...
            return [4
            /*yield*/
            , wait(paymentMethodStatusWaitTime)];

...
function useFullPayment(_a) {
    var orgID = _a.orgID, _b = _a.invoiceID, existingInvoiceID = _b === void 0 ? "" : _b, lotID = _a.lotID, lotType = _a.lotType, savedPaymentMethods = _a.savedPaymentMethods, selectedPaymentMethod = _a.selectedPaymentMethod, _c = _a.debug, debug = _c === void 0 ? false : _c;
    var _d = useState({
        paymentStatus: "processing",
        paymentReferenceNumber: "",
    }), paymentState = _d[0], setPaymentState = _d[1];
    var selectedBillingInfo = selectedPaymentMethod.billingInfo, selectedPaymentInfo = selectedPaymentMethod.paymentInfo;
    var createPaymentMethod = useCreatePaymentMethod()[0];
    var createAuctionInvoice = useCreateAuctionInvoiceMutation()[0];
    var createBuyNowInvoice = useCreateBuyNowInvoiceMutation()[0];
    // TODO: There's another mutation, PurchaseBuyNow, to create invoice and pay that also makes a reservation.
    var makePayment = useCreatePaymentMutation()[0];
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        if (!(typeof selectedPaymentInfo === "string")) return [3 /*break*/, 1];
                    ...
                    case 1:
                        ...
                        if (typeof selectedBillingInfo === "string") {
                            ...
                            selectedBillingInfoData = savedPaymentMethodToBillingInfo(selectedPaymentMethod_1);
                        }
                        else {
                        ...
                        return [4 /*yield*/, createPaymentMethod(orgID, selectedBillingInfoData, selectedPaymentInfo).catch(function (error) {
                                var parsedCircleError = parseCircleError(error);
                                if (debug)
                    ...
                    case 3:
                        ...
                        if (!!invoiceID) return [3 /*break*/, 7];
                        if (!(lotType === "auction")) return [3 /*break*/, 5];
                        return [4 /*yield*/, createAuctionInvoice({
                                variables: {
                                    orgID: orgID,
                                    lotID: lotID,
                                },
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5:
                        if (!(lotType === "buyNow")) return [3 /*break*/, 7];
                        return [4 /*yield*/, createBuyNowInvoice({
                                variables: {
                                    input: {
                                        itemCount: 1,
                    ...
                    case 7:
                        ...
                        if (!paymentMethodStatusWaitTime) return [3 /*break*/, 9];
                        return [4 /*yield*/, wait(paymentMethodStatusWaitTime)];
                    case 8:
                        _k.sent();
                        _k.label = 9;
                    case 9: return [4 /*yield*/, makePayment({
                            variables: {
                                paymentMethodID: paymentMethodID,
                                invoiceID: invoiceID,
                            },

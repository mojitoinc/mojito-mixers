...
var PaymentMethodSelector = function (_a) {
    ...
    return (React__default.createElement(ToggleButtonGroup, { value: selectedPaymentMethod, exclusive: true, onChange: handleChange, "aria-label": "payment method", sx: { mb: 3.5 } }, paymentMethods.map(function (paymentMethod) {

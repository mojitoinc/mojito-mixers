...
const CheckboxIconUnchecked = () => (React__default.createElement(SvgIcon, null,
...
const CheckboxIconChecked = () => (React__default.createElement(SvgIcon, null,
    React__default.createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const Checkbox = (_a) => {
    ...
    return (React__default.createElement(FormControl, { sx: sx, error: error },
        React__default.createElement(FormControlLabel, { label: label, control: React__default.createElement(MuiCheckbox, Object.assign({ sx: { paddingLeft: 1.5, paddingRight: 0.5, paddingTop: 1.5 }, checked: checked, onChange: onChange, icon: React__default.createElement(CheckboxIconUnchecked, null), checkedIcon: React__default.createElement(CheckboxIconChecked, null), disableRipple: true }, props)) }),

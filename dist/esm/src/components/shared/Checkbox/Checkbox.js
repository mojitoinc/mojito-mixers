...
var CheckboxIconUnchecked = function CheckboxIconUnchecked() {
  return /*#__PURE__*/React__default.createElement(SvgIcon, null, /*#__PURE__*/React__default.createElement("svg", {
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
    fill: "none",
...
var Checkbox = function Checkbox(_a) {
  var label = _a.label,
      ...
      props = __rest(_a, ["label", "checked", "onChange", "sx", "error", "helperText"]);
  ...
  return /*#__PURE__*/React__default.createElement(FormControl, {
    ...
    label: label,
    control: /*#__PURE__*/React__default.createElement(MuiCheckbox, __assign({
      sx: {
        paddingLeft: 1.5,
        paddingRight: 0.5,
        paddingTop: 1.5
      ...
      checked: checked,
      onChange: onChange,
      icon: /*#__PURE__*/React__default.createElement(CheckboxIconUnchecked, null),
      checkedIcon: /*#__PURE__*/React__default.createElement(CheckboxIconChecked, null),
      disableRipple: true
    }, props))
  ...
  return /*#__PURE__*/React__default.createElement(Controller, {
    ...
    render: function render(_a) {
      var _b = _a.field,
          ...
          ref = _b.ref,
          value = _b.value,
          field = __rest(_b, ["name", "onChange", "ref", "value"]),
          fieldState = _a.fieldState;

      var error = fieldState === null || fieldState === void 0 ? void 0 : fieldState.error;
      return /*#__PURE__*/React__default.createElement(Checkbox, __assign({
        id: name,
        name: name,
        label: label,
        checked: value,

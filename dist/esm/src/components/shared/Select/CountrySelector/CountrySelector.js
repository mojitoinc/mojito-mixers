...
const ControlledCountrySelector = ({ name, control, label, }) => (React__default.createElement(Controller, { name: name, control: control, render: (_a) => {
        ...
        return (React__default.createElement(CountrySelector, Object.assign({ id: name, name: name, label: label, onSelectCountry: onChange, fullWidth: true, inputRef: ref, error: !!error, helperText: error === null || error === void 0 ? void 0 : error.message }, field)));
    } }));

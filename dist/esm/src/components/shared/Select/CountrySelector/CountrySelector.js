...
var CountrySelector = function (_a) {
    var label = _a.label, value = _a.value, disabled = _a.disabled, onSelectCountry = _a.onSelectCountry, props = __rest(_a, ["label", "value", "disabled", "onSelectCountry"]);
    var _b = useCountryOptions(), options = _b.options, optionsMap = _b.optionsMap;
    ...
    useEffect(function () {
        ...
        setTimeout(function () { return onSelectCountry(option || EMPTY_OPTION); });
...
var ControlledCountrySelector = function (_a) {
    ...
    return (React__default.createElement(Controller, { name: name, control: control, render: function (_a) {
            ...
            return (React__default.createElement(CountrySelector, __assign({ id: name, name: name, label: label, onSelectCountry: onChange, fullWidth: true, inputRef: ref, error: !!error, helperText: error === null || error === void 0 ? void 0 : error.message }, field)));
        } }));
};

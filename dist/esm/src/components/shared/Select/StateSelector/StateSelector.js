...
const ControlledStateSelector = ({ name, control, label, countryCode, }) => (React__default.createElement(Controller, { name: name, control: control, render: (_a) => {
        ...
        return (React__default.createElement(StateSelector, Object.assign({ id: name, name: name, label: label, onSelectState: onChange, fullWidth: true, countryCode: countryCode, inputRef: ref, error: !!error, helperText: error === null || error === void 0 ? void 0 : error.message }, field)));
    } }));

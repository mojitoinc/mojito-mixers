...
var StateSelector = function (_a) {
    var label = _a.label, value = _a.value, disabled = _a.disabled, onSelectState = _a.onSelectState, countryCode = _a.countryCode, props = __rest(_a, ["label", "value", "disabled", "onSelectState", "countryCode"]);
    var _b = useCountryOptions(countryCode), options = _b.options, optionsMap = _b.optionsMap;
    var handleChange = useCallback(function (e) {
        onSelectState(optionsMap[e.target.value]);
    }, [optionsMap, onSelectState]);
    var isDisabled = disabled || !countryCode || options.length === 0;
    ...
    useEffect(function () {
        ...
        setTimeout(function () { return onSelectState(option || EMPTY_OPTION); });
    }, [value, optionsMap, options, onSelectState, countryCode]);
    return (React__default.createElement(Select, __assign({}, props, { label: label, options: options, onChange: handleChange, value: value.value, disabled: isDisabled })));
};
var ControlledStateSelector = function (_a) {
    var name = _a.name, control = _a.control, label = _a.label, countryCode = _a.countryCode;
    return (React__default.createElement(Controller, { name: name, control: control, render: function (_a) {
            var _b;
            var _c = _a.field, name = _c.name, onChange = _c.onChange, ref = _c.ref, field = __rest(_c, ["name", "onChange", "ref"]), fieldState = _a.fieldState;
            var error = (_b = fieldState === null || fieldState === void 0 ? void 0 : fieldState.error) === null || _b === void 0 ? void 0 : _b.value;
            return (React__default.createElement(StateSelector, __assign({ id: name, name: name, label: label, onSelectState: onChange, fullWidth: true, countryCode: countryCode, inputRef: ref, error: !!error, helperText: error === null || error === void 0 ? void 0 : error.message }, field)));
        } }));
};

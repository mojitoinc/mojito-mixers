...
function StackList(_a) {
    ...
    var renderedList = useMemo(function () {
        return (React__default.createElement(Stack, { component: "ol", spacing: 1 }, data.map(function (itemData, index) {
            ...
            return (React__default.createElement(ItemComponent, { key: key, id: key, index: index, data: itemData, additionalProps: additionalProps }));
        })));

...
var SelectIcon = function SelectIcon(props) {
  return /*#__PURE__*/React__default.createElement(SvgIcon, __assign({}, props), /*#__PURE__*/React__default.createElement("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
var CreditCardIcon = function CreditCardIcon(_a) {
  var network = _a.network,
      props = __rest(_a, ["network"]);

  return /*#__PURE__*/React__default.createElement(SvgIcon, __assign({}, standaloneGetCardImageProps(network), props, {
    sx: __assign(__assign({}, CREDIT_CARD_ICON_SX), props.sx)
  }));
};

...
var CheckoutModal = function (_a) {
    ...
    var savedPaymentMethods = useMemo(function () { return transformRawSavedPaymentMethods(rawSavedPaymentMethods); }, [rawSavedPaymentMethods]);
    var dialogRootRef = useRef(null);
    var paperRef = useRef(null);
    var _e = useState(""), paymentError = _e[0], setPaymentError = _e[1];
    var _f = useState(0), checkoutStepIndex = _f[0], setCheckoutStepIndex = _f[1];
    var _g = useState({
        billingInfo: "",
        paymentInfo: "",
    ...
    var resetModalState = useCallback(function () {
        ...
        var selectedBillingInfo = INITIAL_PLAID_OAUTH_FLOW_STATE.selectedBillingInfo, continueOAuthFlow = INITIAL_PLAID_OAUTH_FLOW_STATE.continueOAuthFlow, savedStateUsed = INITIAL_PLAID_OAUTH_FLOW_STATE.savedStateUsed;
        setPaymentError("");
    ...
    var handleSavedPaymentMethodDeleted = useCallback(function (addressIdOrPaymentMethodId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var _h = useState(""), paymentReferenceNumber = _h[0], setPaymentReferenceNumber = _h[1];
    ...
    var _j = useShakeAnimation(paperRef.current), shakeSx = _j[0], shake = _j[1];
    var _k = useState(false), isDialogBlocked = _k[0], setIsDialogBlocked = _k[1];
    ...
    var theme = useMemo(function () { return themeOptions ? createTheme(themeOptions) : parentTheme; }, [parentTheme, themeOptions]);
    ...
    return (React__default.createElement(Wrapper, __assign({}, wrapperProps),
        React__default.createElement(Dialog, { open: isDialogBlocked ? true : open, onClose: isDialogBlocked ? undefined : onClose, onBackdropClick: isDialogBlocked ? shake : undefined, "aria-labelledby": "checkout-modal-header-title", fullWidth: true, maxWidth: "sm", scroll: "body", ref: dialogRootRef, PaperProps: { sx: shakeSx, ref: paperRef } },
            React__default.createElement(DialogContent, { sx: {
                ...
                React__default.createElement(CheckoutModalHeader, { variant: headerVariant, logoSrc: logoSrc, logoSx: logoSx, user: (_b = meData === null || meData === void 0 ? void 0 : meData.me) === null || _b === void 0 ? void 0 : _b.user, userFormat: userFormat, onLoginClicked: onLogin, onPrevClicked: handlePrevClicked }),
                checkoutStepElement))));
};

...
const CheckoutDeliveryAndItemCostBreakdown = ({ checkoutItems, taxes, validatePersonalDeliveryAddress, wallets, wallet, onWalletChange, dictionary, }) => (React__default.createElement(Stack, { sx: { display: "flex", width: { xs: "100%", md: "calc(50% - 35px)" } } },
    React__default.createElement(DeliveryWalletSelector, { validatePersonalAddress: validatePersonalDeliveryAddress, wallets: wallets, wallet: wallet, onWalletChange: onWalletChange, dictionary: dictionary }),

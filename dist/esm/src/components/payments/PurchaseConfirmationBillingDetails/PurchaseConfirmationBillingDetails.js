...
var PurchaseConfirmationBillingDetails = function (_a) {
    ...
    var _b = getFormattedPaymentMethod(selectedPaymentMethodPaymentInfo), isMasked = _b.isMasked, paymentType = _b.paymentType, displayValue = _b.displayValue, network = _b.network;
    var icon = network ? React__default.createElement(CreditCardIcon, { network: network }) : null;

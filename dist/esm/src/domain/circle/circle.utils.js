...
function transformRawSavedPaymentMethods(rawSavedPaymentMethods) {
    ...
    return rawSavedPaymentMethods.map(function (_a) {
        var billingDetails = _a.billingDetails, metadata = _a.metadata, rest = __rest(_a, ["billingDetails", "metadata"]);
        ...
        var savedPaymentMethod = __assign(__assign(__assign({}, rest), savedPaymentInfoBillingInfo), { addressId: getSavedPaymentMethodAddressId(savedPaymentInfoBillingInfo) });

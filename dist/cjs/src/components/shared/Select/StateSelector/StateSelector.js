...
var StateSelector = function (_a) {
    var label = _a.label, value = _a.value, disabled = _a.disabled, onSelectState = _a.onSelectState, countryCode = _a.countryCode, props = tslib_es6.__rest(_a, ["label", "value", "disabled", "onSelectState", "countryCode"]);
    var _b = useCountryOptions.useCountryOptions(countryCode), options = _b.options, optionsMap = _b.optionsMap;
    ...
    React.useEffect(function () {
        ...
        setTimeout(function () { return onSelectState(option || Select.EMPTY_OPTION); });
...
var ControlledStateSelector = function (_a) {
    ...
    return (React__default["default"].createElement(reactHookForm.Controller, { name: name, control: control, render: function (_a) {
            ...
            return (React__default["default"].createElement(StateSelector, tslib_es6.__assign({ id: name, name: name, label: label, onSelectState: onChange, fullWidth: true, countryCode: countryCode, inputRef: ref, error: !!error, helperText: error === null || error === void 0 ? void 0 : error.message }, field)));
        } }));
};

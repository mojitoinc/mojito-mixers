...
var CountrySelector = function CountrySelector(_a) {
  var label = _a.label,
      ...
      props = tslib_es6.__rest(_a, ["label", "value", "disabled", "onSelectCountry"]);

  var _b = useCountryOptions.useCountryOptions(),
      options = _b.options,
  ...
  React.useEffect(function () {
    ...
    if (!optionsMap[countryCode]) onSelectCountry(Select.EMPTY_OPTION);
  ...
  React.useEffect(function () {
    ...
    setTimeout(function () {
      return onSelectCountry(option || Select.EMPTY_OPTION);
    });
...
var ControlledCountrySelector = function ControlledCountrySelector(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactHookForm.Controller, {
    ...
    render: function render(_a) {
      ...
      return /*#__PURE__*/React__default["default"].createElement(CountrySelector, tslib_es6.__assign({
        id: name,
        name: name,
        label: label,

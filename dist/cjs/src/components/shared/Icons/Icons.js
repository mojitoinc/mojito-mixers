...
const SelectIcon = (props) => (React__default["default"].createElement(material.SvgIcon, Object.assign({}, props),
...
const CreditCardIcon = (_a) => {
    ...
    return (React__default["default"].createElement(material.SvgIcon, Object.assign({}, payment_utils.standaloneGetCardImageProps(network), props, { sx: Object.assign(Object.assign({}, CREDIT_CARD_ICON_SX), props.sx) })));
};

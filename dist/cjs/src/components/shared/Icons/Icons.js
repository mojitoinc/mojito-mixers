...
var CREDIT_CARD_ICON_SX = {
  width: "35px",
  height: "24px"
};
var SelectIcon = function SelectIcon(props) {
  return /*#__PURE__*/React__default["default"].createElement(material.SvgIcon, tslib_es6.__assign({}, props), /*#__PURE__*/React__default["default"].createElement("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
var CreditCardIcon = function CreditCardIcon(_a) {
  var network = _a.network,
      props = tslib_es6.__rest(_a, ["network"]);

  return /*#__PURE__*/React__default["default"].createElement(material.SvgIcon, tslib_es6.__assign({}, payment_utils.standaloneGetCardImageProps(network), props, {
    sx: tslib_es6.__assign(tslib_es6.__assign({}, CREDIT_CARD_ICON_SX), props.sx)
  }));
};

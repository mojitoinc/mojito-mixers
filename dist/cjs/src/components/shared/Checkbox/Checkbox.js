...
const CheckboxIconUnchecked = () => (React__default["default"].createElement(material.SvgIcon, null,
...
const CheckboxIconChecked = () => (React__default["default"].createElement(material.SvgIcon, null,
    React__default["default"].createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const Checkbox = (_a) => {
    ...
    return (React__default["default"].createElement(material.FormControl, { sx: sx, error: error },
        React__default["default"].createElement(FormControlLabel["default"], { label: label, control: React__default["default"].createElement(Checkbox$1["default"], Object.assign({ sx: { paddingLeft: 1.5, paddingRight: 0.5, paddingTop: 1.5 }, checked: checked, onChange: onChange, icon: React__default["default"].createElement(CheckboxIconUnchecked, null), checkedIcon: React__default["default"].createElement(CheckboxIconChecked, null), disableRipple: true }, props)) }),

...
var ConsentText = function ConsentText(_a) {
  ...
  var linkElements = [privacyHref ? /*#__PURE__*/React__default["default"].createElement(material.Link, {
    color: "text.primary",
    href: privacyHref,
    target: "_blank"
  }, "Privacy Notices") : null, termsOfUseHref ? /*#__PURE__*/React__default["default"].createElement(material.Link, {
    color: "text.primary",
    href: termsOfUseHref,
    target: "_blank"
  }, "Terms of Use") : null].filter(Boolean);
  var lastLinkElementsIndex = linkElements.length - 1;
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, "have read, understood, and consent to the", " ", linkElements.map(function (linkElement, i) {

...
var CheckoutModal = function CheckoutModal(_a) {
  ...
  var _c = graphqlGenerated.useMeQuery({
  ...
  var savedPaymentMethods = React.useMemo(function () {
    return circle_utils.transformRawSavedPaymentMethods(rawSavedPaymentMethods);
  ...
  var resetModalState = React.useCallback(function () {
    ...
    CheckoutStepper.resetStepperProgress(); // Once authentication has loaded, we know if we need to skip the product confirmation step or not. Also, when the
    // modal is re-opened, we need to reset its state, taking into account if we need to resume a Plaid OAuth flow:s

    var selectedBillingInfo = usePlaid.INITIAL_PLAID_OAUTH_FLOW_STATE.selectedBillingInfo,
        continueOAuthFlow = usePlaid.INITIAL_PLAID_OAUTH_FLOW_STATE.continueOAuthFlow,
        savedStateUsed = usePlaid.INITIAL_PLAID_OAUTH_FLOW_STATE.savedStateUsed;
    setPaymentError("");
  ...
  var handleSavedPaymentMethodDeleted = React.useCallback(function (addressIdOrPaymentMethodId) {
  ...
  var _j = animationUtils.useShakeAnimation(paperRef.current),
      shakeSx = _j[0],
      shake = _j[1];
  ...
  var theme = React.useMemo(function () {
    return themeOptions ? createTheme["default"](themeOptions) : parentTheme;
  ...
  if (isDialogLoading || isPlaidFlowLoading) {
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, isPlaidFlowLoading && /*#__PURE__*/React__default["default"].createElement(usePlaid.PlaidFlow, {
      onSubmit: handlePlaidFlowCompleted
    }), /*#__PURE__*/React__default["default"].createElement(material.Backdrop, {
      open: open,
      onClick: onClose
    }, loaderImageSrc ? /*#__PURE__*/React__default["default"].createElement(material.Box, {
      component: "img",
      src: loaderImageSrc,
      sx: {
        width: 196,
  ...
  if (paymentError) {
    headerVariant = "error";
    checkoutStepElement = /*#__PURE__*/React__default["default"].createElement(ErrorView.ErrorView, {
    ...
    checkoutStepElement = /*#__PURE__*/React__default["default"].createElement(AuthenticationView.AuthenticationView, {
    ...
    checkoutStepElement = /*#__PURE__*/React__default["default"].createElement(BillingView.BillingView, {
      checkoutItem: checkoutItem,
    ...
    checkoutStepElement = /*#__PURE__*/React__default["default"].createElement(PaymentView.PaymentView, {
      checkoutItem: checkoutItem,
      savedPaymentMethods: savedPaymentMethods,
    ...
    checkoutStepElement = /*#__PURE__*/React__default["default"].createElement(PurchasingView.PurchasingView, {
    ...
    checkoutStepElement = /*#__PURE__*/React__default["default"].createElement(ConfirmationView.ConfirmationView, {
      checkoutItem: checkoutItem,
      savedPaymentMethods: savedPaymentMethods,
      selectedPaymentMethod: selectedPaymentMethod,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Wrapper, tslib_es6.__assign({}, wrapperProps), /*#__PURE__*/React__default["default"].createElement(material.Dialog, {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(CheckoutModalHeader.CheckoutModalHeader, {

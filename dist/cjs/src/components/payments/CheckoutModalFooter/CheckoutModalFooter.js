...
var CheckoutModalFooter = function CheckoutModalFooter(_a) {
  ...
  var consentTextElement = showConsent ? /*#__PURE__*/React__default["default"].createElement(ConsentText.ConsentText, {
  ...
  }, showConsent && consentType === "checkbox" && /*#__PURE__*/React__default["default"].createElement(Checkbox.Checkbox, {
    label: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, "I ", consentTextElement),
    checked: isConsentChecked,
    onChange: handleConsentClicked,
    error: showConsentError,
    helperText: showConsentError ? ConsentText.CONSENT_ERROR_MESSAGE : undefined,
    sx: {
      alignSelf: "flex-start",
      mb: 5
    }
  }), primaryButtonVisible && /*#__PURE__*/React__default["default"].createElement(PrimaryButton.PrimaryButton, {
    onClick: onSubmitClicked ? handleSubmitClicked : undefined,
    type: onSubmitClicked ? "button" : "submit",
    endIcon: PrimaryButtonIcon && /*#__PURE__*/React__default["default"].createElement(PrimaryButtonIcon, null),
    disabled: submitDisabled
  }, primaryButtonLabel), variant !== "toMarketplace" && /*#__PURE__*/React__default["default"].createElement(material.Typography, {
    sx: primaryButtonVisible ? {
      pt: 2
    } : undefined
  }, primaryButtonVisible ? "or " : null, /*#__PURE__*/React__default["default"].createElement(material.Link, {
    sx: {
      color: "text.primary"
    },
    href: "",
    onClick: handleCancelClicked
  }, "Cancel and Return to Marketplace")), showConsent && consentType === "disclaimer" && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(material.Divider, {
    sx: {
      my: 5,
      width: "100%"
    }

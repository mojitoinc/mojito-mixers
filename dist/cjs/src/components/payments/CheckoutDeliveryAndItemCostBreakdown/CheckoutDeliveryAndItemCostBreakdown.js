...
const CheckoutDeliveryAndItemCostBreakdown = ({ checkoutItems, taxes, validatePersonalDeliveryAddress, wallets, wallet, onWalletChange, }) => (React__default["default"].createElement(material.Stack, { sx: { display: "flex", width: { xs: "100%", md: "calc(50% - 35px)" } } },

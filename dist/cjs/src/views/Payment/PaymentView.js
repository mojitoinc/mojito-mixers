...
var billingInfoItemBoxProps = {
  sx: {
    mt: 2.5
  }
};
var PaymentView = function PaymentView(_a) {
  var checkoutItem = _a.checkoutItem,
      rawSavedPaymentMethods = _a.savedPaymentMethods,
      selectedPaymentMethod = _a.selectedPaymentMethod,
      onPaymentInfoSelected = _a.onPaymentInfoSelected,
      onSavedPaymentMethodDeleted = _a.onSavedPaymentMethodDeleted,
      onNext = _a.onNext,
      onPrev = _a.onPrev,
      onClose = _a.onClose,
  ...
  var selectedPaymentMethodBillingInfo = React.useMemo(function () {
    return typeof selectedBillingInfo === "string" ? rawSavedPaymentMethods.find(function (_a) {
      var addressId = _a.addressId;
  ...
  var handleSavedPaymentMethodDeleted = React.useCallback(function (savedPaymentMethodId) {
      ...
      return tslib_es6.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , onSavedPaymentMethodDeleted(savedPaymentMethodId)];
          ...
          case 1:
            ...
            setViewState({
              isDeleting: false,
              showSaved: remainingPaymentMethods > 0
            });
            return [2
            /*return*/
            ];
  ...
  }, [showSaved, onPaymentInfoSelected, savedPaymentMethods, selectedPaymentInfo]); // PLAIN LINKS:
  ...
  }), /*#__PURE__*/React__default["default"].createElement(CheckoutStepper.CheckoutStepper, {
    progress: 100
  }), /*#__PURE__*/React__default["default"].createElement(BillingInfoItem.BillingInfoItem, {
    data: selectedPaymentMethodBillingInfo,
    additionalProps: {
      onEdit: onPrev,
      disabled: isDeleting,
      boxProps: billingInfoItemBoxProps
    }
  }), /*#__PURE__*/React__default["default"].createElement(material.Divider, {
    sx: {
      mt: 2.5
    }
  }), showSaved ? /*#__PURE__*/React__default["default"].createElement(SavedPaymentDetailsSelector.SavedPaymentDetailsSelector, {
  ...
  }) : /*#__PURE__*/React__default["default"].createElement(PaymentMethodForm.PaymentMethodForm, {

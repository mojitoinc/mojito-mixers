...
var BillingView = function BillingView(_a) {
  var checkoutItem = _a.checkoutItem,
      rawSavedPaymentMethods = _a.savedPaymentMethods,
      selectedBillingInfo = _a.selectedBillingInfo,
      onBillingInfoSelected = _a.onBillingInfoSelected,
  ...
  var savedPaymentMethods = React.useMemo(function () {
    return arrayUtils.distinctBy(rawSavedPaymentMethods, "addressId");
  ...
  var handleShowForm = React.useCallback(function (savedPaymentMethodAddressId) {
    if (savedPaymentMethodAddressId && typeof savedPaymentMethodAddressId === "string") {
      ...
      if (data) onBillingInfoSelected(circle_utils.savedPaymentMethodToBillingInfo(data));
    }
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(CheckoutItemCostBreakdown.CheckoutItemCostBreakdown, {
    ...
    progress: 50
  }), showSaved ? /*#__PURE__*/React__default["default"].createElement(SavedBillingDetailsSelector.SavedBillingDetailsSelector, {
    ...
    onNext: onNext,
    onClose: onClose
  }) : /*#__PURE__*/React__default["default"].createElement(BillingInfoForm.BillingInfoForm // variant="loggedIn"
  , {
    // variant="loggedIn"

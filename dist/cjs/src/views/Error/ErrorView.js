...
const ErrorView = ({ errorMessage = "The purchase could not be completed.", errorImageSrc, onReviewData, onClose, }) => {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement(CheckoutModalFooter.CheckoutModalFooter, { variant: "toForm", privacyHref: "", termsOfUseHref: "", onSubmitClicked: onReviewData, onCloseClicked: onClose })));
};

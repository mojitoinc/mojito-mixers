...
var PAYMENT_TYPE_FORM_DATA = {
  CreditCard: {
    ...
    schemaShape: {
      cardNumber: yup.string().label(FIELD_LABELS.cardNumber).when("type", {
        is: "CreditCard",
      ...
      expiryDate: yup.string().label(FIELD_LABELS.expiryDate).when("type", {
        is: "CreditCard",
        then: function then(schema) {
          return schema.required().test({
      ...
      secureCode: yup.string().label(FIELD_LABELS.secureCode).when("type", {
        is: "CreditCard",
        then: function then(schema) {
          return schema.required().test({
      ...
      nameOnCard: yup.string().label(FIELD_LABELS.nameOnCard).when("type", isCreditCardThenRequireSchema)
    },
    fields: function fields(_a) {
      ...
      return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(CardNumberField.ControlledCardNumberField, {
        name: "cardNumber",
        control: control,
        label: FIELD_LABELS.cardNumber
      }), /*#__PURE__*/React__default["default"].createElement(Grid["default"], {
        container: true,
        columnSpacing: 2,
        direction: {
          xs: "column",
        ...
        sm: 6,
        zeroMinWidth: true
      }, /*#__PURE__*/React__default["default"].createElement(CardExpiryDateField.ControlledCardExpiryDateField, {
        name: "expiryDate",
        control: control,
        ...
        item: true,
        sm: 6
      }, /*#__PURE__*/React__default["default"].createElement(CardSecureCodeField.ControlledCardSecureCodeField, {
        name: "secureCode",
        control: control,
        label: FIELD_LABELS.secureCode
      }))), /*#__PURE__*/React__default["default"].createElement(TextField.ControlledTextField, {
        name: "nameOnCard",
        control: control,
        label: FIELD_LABELS.nameOnCard
      }), consentType === "checkbox" && /*#__PURE__*/React__default["default"].createElement(Checkbox.ControlledCheckbox, {
        name: "consent",
        control: control,
        label: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, "I ", /*#__PURE__*/React__default["default"].createElement(ConsentText.ConsentText, {
  ...
  ACH: {
    ...
    fields: function fields(_a) {
      var control = _a.control,
          ...
          privacyHref = _a.privacyHref,
          termsOfUseHref = _a.termsOfUseHref;
      return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(DisplayBox.DisplayBox, {
        sx: {
          mt: 1.5,
        ...
        variant: "body1"
      }, "We use Plaid to connect to your account.")), consentType === "checkbox" && /*#__PURE__*/React__default["default"].createElement(Checkbox.ControlledCheckbox, {
        name: "consent",
        control: control,
        label: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, "I ", /*#__PURE__*/React__default["default"].createElement(ConsentText.ConsentText, {
          privacyHref: privacyHref,
  ...
  Wire: {
    ...
    fields: function fields(_a) {
      ...
      return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(DisplayBox.DisplayBox, {
        ...
        variant: "body1"
      }, "Not supported yet.")), consentType === "checkbox" && /*#__PURE__*/React__default["default"].createElement(Checkbox.ControlledCheckbox, {
        name: "consent",
        control: control,
        label: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, "I ", /*#__PURE__*/React__default["default"].createElement(ConsentText.ConsentText, {
          privacyHref: privacyHref,
...
var PaymentMethodForm = function PaymentMethodForm(_a) {
  ...
  var schema = React.useMemo(function () {
    return yup.object().shape(tslib_es6.__assign({
      type: yup.string().required(),
      consent: yup.boolean().oneOf([true], ConsentText.CONSENT_ERROR_MESSAGE)
  ...
  var handleFormSubmit = React.useCallback(function (e) {
  ...
  }, onSaved && /*#__PURE__*/React__default["default"].createElement(Box["default"], {
    sx: {
      my: 2.5
    }
  }, /*#__PURE__*/React__default["default"].createElement(SecondaryButton.SecondaryButton, {
    onClick: onSaved,
    startIcon: /*#__PURE__*/React__default["default"].createElement(Book["default"], null)
  }, "Use Saved Payment Method")), acceptedPaymentTypes.length > 1 ? /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(InputGroupLabel.InputGroupLabel, {
    sx: {
      m: 0,
      pt: 2,
      pb: 1.5
    }
  }, "Payment Method"), /*#__PURE__*/React__default["default"].createElement(PaymentMethodSelector.PaymentMethodSelector, {
    selectedPaymentMethod: selectedPaymentMethod,
    onPaymentMethodChange: handleSelectedPaymentMethodChange,
    paymentMethods: acceptedPaymentTypes
  })) : null, /*#__PURE__*/React__default["default"].createElement(Fields, {
    control: control,
    consentType: consentType,
    privacyHref: privacyHref,
    termsOfUseHref: termsOfUseHref
  }), debug && /*#__PURE__*/React__default["default"].createElement(DisplayBox.DebugBox, {
    sx: {
      my: 2
    }
  }, JSON.stringify(watch(), null, 2)), /*#__PURE__*/React__default["default"].createElement(CheckoutModalFooter.CheckoutModalFooter, {

    ...
    return tslib_es6.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_es6.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ciphertext = _b.sent();
                    return [2 /*return*/, btoa__default["default"](ciphertext)];
            }
        });
    });
}
function useCreatePaymentMethod() {
    ...
    var _a = graphqlGenerated.useCreatePaymentMethodMutation(), createPaymentMethod = _a[0], createPaymentMethodResult = _a[1];
    var extendedCreatePaymentMethod = React.useCallback(function (orgID, billingInfo, paymentInfo) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_es6.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (!(paymentInfo.type === graphqlGenerated.PaymentType.CreditCard)) return [3 /*break*/, 3];
                    return [4 /*yield*/, fetchPaymentKey().catch(function (err) { return undefined; })];
                case 1:
                    ...
                    return [4 /*yield*/, encryptCard(publicKey, paymentInfo.cardNumber.replace(/\s/g, ""), paymentInfo.secureCode)];
                case 2:
                    encryptedCardData = _d.sent();
                    _a = paymentInfo.expiryDate.split("/").map(function (value) { return parseInt(value.trim(), 10); }), expirationMonth = _a[0], expirationYearLastTwoDigits = _a[1];
                    expirationYear = 2000 + expirationYearLastTwoDigits;
                    return [2 /*return*/, createPaymentMethod({
                            variables: {
                                orgID: orgID,
                                input: {

...
var mojitoLightTheme = createTheme["default"]({
  ...
  palette: themePalette.createPaletteTheme({
    mode: "light"
  })
});
var MOJITO_LIGHT_THEME = createTheme["default"](tslib_es6.__assign(tslib_es6.__assign({}, mojitoLightTheme), {
  components: themeComponents.createComponentsTheme(mojitoLightTheme)
}));
...
var MOJITO_DARK_THEME = createTheme["default"](tslib_es6.__assign(tslib_es6.__assign({}, mojitoDarkTheme), {
  components: themeComponents.createComponentsTheme(mojitoDarkTheme)
}));

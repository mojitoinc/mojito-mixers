...
var popper = require('../../../@popperjs/core/lib/popper.js');
...
const PopperTooltip = /*#__PURE__*/React__namespace.forwardRef(function PopperTooltip(props, ref) {
  ...
  const ownRef = useForkRef["default"](tooltipRef, ref);
  const popperRef = React__namespace.useRef(null);
  const handlePopperRef = useForkRef["default"](popperRef, popperRefProp);
  ...
  useEnhancedEffect["default"](() => {
    ...
    const popper$1 = popper.createPopper(resolveAnchorEl(anchorEl), tooltipRef.current, _extends["default"]({
  ...
  return /*#__PURE__*/require$$2.jsx("div", _extends["default"]({
    ref: ownRef,
    role: "tooltip"
  }, other, {
...
const PopperUnstyled = /*#__PURE__*/React__namespace.forwardRef(function PopperUnstyled(props, ref) {
  ...
  return /*#__PURE__*/require$$2.jsx(Portal["default"], {
    disablePortal: disablePortal,
    container: container,
    children: /*#__PURE__*/require$$2.jsx(PopperTooltip, _extends["default"]({
      anchorEl: anchorEl,
      direction: direction,
      disablePortal: disablePortal,
      modifiers: modifiers,
...
= {
   ...
   */
  anchorEl: chainPropTypes["default"](index["default"].oneOfType([HTMLElementType["default"], index["default"].object, index["default"].func]), props => {
    if (props.open) {
   ...
   * @default 'ltr'
   */
  direction: index["default"].oneOf(['ltr', 'rtl']),
...
exports["default"] = PopperUnstyled$1;

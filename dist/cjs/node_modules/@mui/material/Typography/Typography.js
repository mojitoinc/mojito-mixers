...
const Typography = /*#__PURE__*/React__namespace.forwardRef(function Typography(inProps, ref) {
  ...
  const props = system.unstable_extendSxProp(_extends__default["default"]({}, themeProps, {
    color
  }));
...
= {
   ...
   * @default 'inherit'
   */
  align: index["default"].oneOf(['center', 'inherit', 'justify', 'left', 'right']),
   ...
   * @default false
   */
  gutterBottom: index["default"].bool,
   ...
   * @default false
   */
  noWrap: index["default"].bool,

  /**
   * If `true`, the element will be a paragraph element.
   * @default false
   */
  paragraph: index["default"].bool,
  ...
  .oneOfType([index["default"].oneOf(['body1', 'body2', 'button', 'caption', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'inherit', 'overline', 'subtitle1', 'subtitle2']), index["default"].string]),

...
const SvgIcon = /*#__PURE__*/React__namespace.forwardRef(function SvgIcon(inProps, ref) {
  ...
  return /*#__PURE__*/require$$2.jsxs(SvgIconRoot, _extends["default"]({
    as: component,
...
= {
  ...
  .oneOfType([index["default"].oneOf(['inherit', 'action', 'disabled', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), index["default"].string]),
   ...
   * @default 'medium'
   */
  fontSize: index["default"]
  /* @typescript-to-proptypes-ignore */
  .oneOfType([index["default"].oneOf(['inherit', 'large', 'medium', 'small']), index["default"].string]),

  /**
   * Applies a color attribute to the SVG element.
   */
  htmlColor: index["default"].string,
   ...
   * @default false
   */
  inheritViewBox: index["default"].bool,
   ...
   */
  shapeRendering: index["default"].string,
   ...
   */
  titleAccess: index["default"].string,
   ...
   * @default '0 0 24 24'
   */
  viewBox: index["default"].string
} : void 0;
SvgIcon.muiName = 'SvgIcon';
var SvgIcon$1 = SvgIcon;

exports["default"] = SvgIcon$1;

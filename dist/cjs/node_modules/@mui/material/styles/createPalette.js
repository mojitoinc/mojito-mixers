...
function createPalette(palette) {
  ...
  const augmentColor = ({
    ...
    if (!color.hasOwnProperty('main')) {
      throw new Error(formatMuiErrorMessage["default"](11, name ? ` (${name})` : '', mainShade));
    }

    if (typeof color.main !== 'string') {
      throw new Error(formatMuiErrorMessage["default"](12, name ? ` (${name})` : '', JSON.stringify(color.main)));
    }

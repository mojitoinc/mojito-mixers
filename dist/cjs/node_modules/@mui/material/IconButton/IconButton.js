...
const IconButtonRoot = styled["default"](ButtonBase["default"], {
  ...
  '&:hover': {
    backgroundColor: system.alpha(theme.palette.action.active, theme.palette.action.hoverOpacity),
  ...
  '&:hover': {
    backgroundColor: system.alpha(theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity),
    // Reset on touch devices, it doesn't add specificity
    '@media (hover: none)': {
      backgroundColor: 'transparent'
    }
...
const IconButton = /*#__PURE__*/React__namespace.forwardRef(function IconButton(inProps, ref) {
  ...
  return /*#__PURE__*/require$$2.jsx(IconButtonRoot, _extends["default"]({
...
= {
   ...
   * The icon to display.
   */
  children: chainPropTypes["default"](index["default"].node, props => {
  ...
  .oneOfType([index["default"].oneOf(['inherit', 'default', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), index["default"].string]),

...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', `labelPlacement${capitalize["default"](labelPlacement)}`],
...
const FormControlLabel = /*#__PURE__*/React__namespace.forwardRef(function FormControlLabel(inProps, ref) {
  ...
  return /*#__PURE__*/require$$2.jsxs(FormControlLabelRoot, _extends__default["default"]({
    className: clsx_m["default"](classes.root, className),
    ownerState: ownerState,
    ref: ref
  }, other, {
    children: [/*#__PURE__*/React__namespace.cloneElement(control, controlProps), label.type === Typography["default"] || disableTypography ? label : /*#__PURE__*/require$$2.jsx(Typography["default"], _extends__default["default"]({
      component: "span",

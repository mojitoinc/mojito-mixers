...
const CARD_TYPES_BY_TYPE = CARD_TYPES.reduce((acc, cardType: CardType) => {
  acc[cardType.type] = cardType;
...
const CARD_NAMES_BY_TYPE = CARD_TYPES.reduce((acc, cardType: CardType) => {
  acc[cardType.type] = cardType.displayName;

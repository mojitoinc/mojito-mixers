// Invoice / Reservation:
export const RESERVATION_COUNTDOWN_FROM_MIN = 1;
...
// Purchase:
export const PURCHASING_MIN_WAIT_MS = 3000;
export const PURCHASING_MESSAGES_INTERVAL_MS = 5000;
export const PAYMENT_NOTIFICATION_INTERVAL_MS = 1500;

...
export const CheckboxIconChecked: React.FC<CheckboxIconCheckedProps> = ({
  error,
}) => {
    ...
    <SvgIcon>
      <svg
        ...
        <rect
          ...
          height="19"
          rx="1.5"
          fill={ error ? palette.warning.light : palette.success.light }
          stroke={ error ? palette.warning.dark : palette.success.main } />
        <path
          ...
          fill={ error ? palette.warning.dark : palette.success.main } />
      </svg>
    </SvgIcon>
  );
};

...
export const PLAYGROUND_PURCHASE_INSTRUCTIONS = "Purchased instructions on how to claim item / how item will be delivered can be placed here...";
...
export const PLAYGROUND_MOCKED_LOT: CheckoutItem = {
  lotID: "",
  lotType: "buyNow",
  name: "Your Lot",
